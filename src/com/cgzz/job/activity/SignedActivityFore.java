 ...
 * @author wjm 注册第一步
 */
public class SignedActivityFore extends BaseActivity implements OnClickListener {
		...
		public void back(String data, int encoding, int method, Object obj, boolean loadedtype) {
			...
			case HttpStaticApi.login_Http://
				...
				case HttpStaticApi.FAILURE_HTTP:
					bundle = ParserUtil.ParserMsg(data);
					ToastUtil.makeShortText(SignedActivityFore.this, bundle.get("msg").toString());
	...
	public void ShenHeReceiver() {
		...
		intentobd.putExtra("TYPE", "shenhe");
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("重新提交信息", true, TITLE_TYPE_IMG, R.drawable.stub_back, false, TITLE_TYPE_TEXT, "注册");
	...
	public void onClick(View v) {
		...
		case R.id.tv_signed_next:// 下一步
			...
			age = et_signed_age.getText().toString();
			...
			name = et_signed_name.getText().toString();
...
//			}
			...
			//
			// bundle.putString("card", identification);// 身份证hao
			...
			updateUser(UrlConfig.updateUser_Http, application.getUserId(), application.getToken(), "2", identification,
					cardurl, rb_boys, name, age, true);
...
//					cropImage(uri, 100, 100, CROP_PICTURE);
			...
			case CROP_PICTURE:
				...
				if (picture_typePop) {
					...
					UpdateTextTask mTask = new UpdateTextTask(SignedActivityFore.this);
					mTask.execute(photo);
				} else {

					iv_signed_photo_card.setImageBitmap(photo);

					UpdateTextTask2 mTask2 = new UpdateTextTask2(SignedActivityFore.this);
...
//			String url = getPath(SignedActivityFore.this, uri);
...
//	}
	...
	private void updateUser(String url, String userid, String token, String apptype, String card, String cardUrl,
			String sex, String realname, String workage, boolean loadedtype) {
		showWaitDialog();
		...
		AnsynHttpRequest.requestGetOrPost(AnsynHttpRequest.POST, SignedActivityFore.this, url, map, callbackData,
				GlobalVariables.getRequestQueue(SignedActivityFore.this), HttpStaticApi.login_Http, null, loadedtype);
	}
}
