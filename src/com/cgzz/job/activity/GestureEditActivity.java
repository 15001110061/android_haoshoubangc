...
import com.cgzz.job.gesture.LockIndicator;
...
public class GestureEditActivity extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setTitle("设置手势登录", true, TITLE_TYPE_IMG, R.drawable.stub_back, false,
				TITLE_TYPE_TEXT, "取消");
		setUpViews();
		setUpListeners();
						...
						if (mIsFirstInput) {
							...
							if (inputCode.equals(mFirstPassword)) {
								ToastUtil.makeShortText(
										GestureEditActivity.this, "设置成功");
								application.setGestures(true);
								application
										.setGesturesPasswords(mFirstPassword);
								mGestureContentView.clearDrawlineState(0L);
								onBackPressed();
							} else {
								mTextTip.setText(Html
	...
	public void onBackPressed() {
		super.onBackPressed();
		Intent intent = new Intent(GestureEditActivity.this,
