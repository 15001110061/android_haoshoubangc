...
public class MarkerActivity extends BaseActivity implements OnMarkerClickListener, OnInfoWindowClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("地址", true, TITLE_TYPE_IMG, R.drawable.stub_back, false, TITLE_TYPE_TEXT, "注册");
		...
		try {
			...
			ToastUtil.makeShortText(MarkerActivity.this, "数据出现异常，稍后重试");
			finish();
		}
	...
	public void onInfoWindowClick(Marker marker) {
		...
		ToastUtil.makeShortText(MarkerActivity.this, "当前地图可视区域内Marker数量:" + aMap.getMapScreenMarkers().size());
	}
	...
	public void render(Marker marker, View view) {
		...
		try {
			...
			if (star == 0) {
				...
				win_hotel_message.setText("其他");
				win_hotel_ratingbar.setVisibility(View.GONE);
			} else if (star == 1) {

				win_hotel_message.setVisibility(View.VISIBLE);
				win_hotel_message.setText("宾馆与连锁酒店");
				win_hotel_ratingbar.setVisibility(View.GONE);
